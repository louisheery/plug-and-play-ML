##################################################################
#                                                                #
#      LSTM Graph Plotter (lstm_graph_plotter.py)                #
#                                                                #
#      For plotting Graph of results obtained from the           #
#      lstm_predictor_model.py script.                           #
#                                                                #
#      By Louis Heery                                            #
#                                                                #
##################################################################
...
def plotLSTMGraph(usernumber, timeData, trainData, testData, predictedData):
    import math
    import os
    import warnings
    ...
    ##### Subplot 1 #####
    ax1.set_title("User " + str(usernumber) + " - LSTM NN Predictor")
    ...
    ##### Subplot 2 #####
    ax2.plot(timeData/24, testData - predictedData, label = 'Residual (Test - Predicted)', color = 'green')
    ...
    filename = "LSTM_NN_" + "_user" + str(usernumber) + ".pdf"
